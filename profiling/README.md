...
Throughout the specification, there is also the definition and the `format` property. While the `format` specifies the used data model and proof stack, the `profile` property additionally covers the specification of the revocation system.